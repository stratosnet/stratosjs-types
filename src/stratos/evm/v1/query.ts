...
export const QueryCodeResponse = {
  typeUrl: "/stratos.evm.v1.QueryCodeResponse",
...
export const QueryTxLogsRequest = {
  typeUrl: "/stratos.evm.v1.QueryTxLogsRequest",
...
export const QueryTxLogsResponse = {
  typeUrl: "/stratos.evm.v1.QueryTxLogsResponse",
...
export const QueryTraceTxRequest = {
  ...
  encode(message: QueryTraceTxRequest, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    ...
    if (message.traceConfig !== undefined) {
      TraceConfig.encode(message.traceConfig, writer.uint32(18).fork()).ldelim();
    }
    for (const v of message.predecessors) {
      MsgEthereumTx.encode(v!, writer.uint32(26).fork()).ldelim();
    }
...
function createBaseQueryAddressConvertRequest(): QueryAddressConvertRequest {
  return {
    address: "",
  };
}
export const QueryAddressConvertRequest = {
  typeUrl: "/stratos.evm.v1.QueryAddressConvertRequest",
  encode(message: QueryAddressConvertRequest, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.address !== "") {
      writer.uint32(10).string(message.address);
    }
    return writer;
  },
  decode(input: BinaryReader | Uint8Array, length?: number): QueryAddressConvertRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseQueryAddressConvertRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): QueryAddressConvertRequest {
    const obj = createBaseQueryAddressConvertRequest();
    if (isSet(object.address)) obj.address = String(object.address);
    return obj;
  },
  toJSON(message: QueryAddressConvertRequest): unknown {
    const obj: any = {};
    message.address !== undefined && (obj.address = message.address);
    return obj;
  },
  fromPartial<I extends Exact<DeepPartial<QueryAddressConvertRequest>, I>>(
    object: I,
...
function createBaseQueryAddressConvertResponse(): QueryAddressConvertResponse {
  return {
    hexAddress: "",
    bech32Address: "",
  };
}
export const QueryAddressConvertResponse = {
  typeUrl: "/stratos.evm.v1.QueryAddressConvertResponse",
  encode(message: QueryAddressConvertResponse, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.hexAddress !== "") {
      writer.uint32(10).string(message.hexAddress);
    }
    if (message.bech32Address !== "") {
      writer.uint32(18).string(message.bech32Address);
    }
    return writer;
  },
  decode(input: BinaryReader | Uint8Array, length?: number): QueryAddressConvertResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseQueryAddressConvertResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): QueryAddressConvertResponse {
    const obj = createBaseQueryAddressConvertResponse();
    if (isSet(object.hexAddress)) obj.hexAddress = String(object.hexAddress);
    if (isSet(object.bech32Address)) obj.bech32Address = String(object.bech32Address);
    return obj;
  },
  toJSON(message: QueryAddressConvertResponse): unknown {
    const obj: any = {};
  ...
  fromPartial<I extends Exact<DeepPartial<QueryAddressConvertResponse>, I>>(
    object: I,
  ): QueryAddressConvertResponse {
    const message = createBaseQueryAddressConvertResponse();
...
export interface Query {
  ...
  BaseFeeParam(request?: QueryBaseFeeRequest): Promise<QueryBaseFeeResponse>;
  /** BlockGas queries the gas used at a given block height */
  BlockGas(request?: QueryBlockGasRequest): Promise<QueryBlockGasResponse>;
  AddressConvert(request: QueryAddressConvertRequest): Promise<QueryAddressConvertResponse>;
}
export class QueryClientImpl implements Query {
  ...
  constructor(rpc: Rpc) {
    ...
    this.BaseFeeParam = this.BaseFeeParam.bind(this);
    this.BlockGas = this.BlockGas.bind(this);
    this.AddressConvert = this.AddressConvert.bind(this);
  }
  Account(request: QueryAccountRequest): Promise<QueryAccountResponse> {
    const data = QueryAccountRequest.encode(request).finish();
    const promise = this.rpc.request("stratos.evm.v1.Query", "Account", data);
  ...
  CosmosAccount(request: QueryCosmosAccountRequest): Promise<QueryCosmosAccountResponse> {
    ...
    const promise = this.rpc.request("stratos.evm.v1.Query", "CosmosAccount", data);
  ...
  ValidatorAccount(request: QueryValidatorAccountRequest): Promise<QueryValidatorAccountResponse> {
    ...
    const promise = this.rpc.request("stratos.evm.v1.Query", "ValidatorAccount", data);
    return promise.then((data) => QueryValidatorAccountResponse.decode(new BinaryReader(data)));
  }
  Balance(request: QueryBalanceRequest): Promise<QueryBalanceResponse> {
    const data = QueryBalanceRequest.encode(request).finish();
    const promise = this.rpc.request("stratos.evm.v1.Query", "Balance", data);
  ...
  Storage(request: QueryStorageRequest): Promise<QueryStorageResponse> {
    ...
    const promise = this.rpc.request("stratos.evm.v1.Query", "Storage", data);
    return promise.then((data) => QueryStorageResponse.decode(new BinaryReader(data)));
  }
  Code(request: QueryCodeRequest): Promise<QueryCodeResponse> {
    const data = QueryCodeRequest.encode(request).finish();
    const promise = this.rpc.request("stratos.evm.v1.Query", "Code", data);
    return promise.then((data) => QueryCodeResponse.decode(new BinaryReader(data)));
  }
  Params(request: QueryParamsRequest = {}): Promise<QueryParamsResponse> {
    const data = QueryParamsRequest.encode(request).finish();
    const promise = this.rpc.request("stratos.evm.v1.Query", "Params", data);
    return promise.then((data) => QueryParamsResponse.decode(new BinaryReader(data)));
  }
  EthCall(request: EthCallRequest): Promise<MsgEthereumTxResponse> {
    const data = EthCallRequest.encode(request).finish();
    const promise = this.rpc.request("stratos.evm.v1.Query", "EthCall", data);
    return promise.then((data) => MsgEthereumTxResponse.decode(new BinaryReader(data)));
  }
  EstimateGas(request: EthCallRequest): Promise<EstimateGasResponse> {
    const data = EthCallRequest.encode(request).finish();
    const promise = this.rpc.request("stratos.evm.v1.Query", "EstimateGas", data);
  ...
  TraceTx(request: QueryTraceTxRequest): Promise<QueryTraceTxResponse> {
    ...
    const promise = this.rpc.request("stratos.evm.v1.Query", "TraceTx", data);
  ...
  TraceBlock(request: QueryTraceBlockRequest): Promise<QueryTraceBlockResponse> {
    ...
    const promise = this.rpc.request("stratos.evm.v1.Query", "TraceBlock", data);
  ...
  BaseFee(request: QueryBaseFeeRequest = {}): Promise<QueryBaseFeeResponse> {
    ...
    const promise = this.rpc.request("stratos.evm.v1.Query", "BaseFee", data);
    return promise.then((data) => QueryBaseFeeResponse.decode(new BinaryReader(data)));
  }
  BaseFeeParam(request: QueryBaseFeeRequest = {}): Promise<QueryBaseFeeResponse> {
    const data = QueryBaseFeeRequest.encode(request).finish();
    const promise = this.rpc.request("stratos.evm.v1.Query", "BaseFeeParam", data);
    return promise.then((data) => QueryBaseFeeResponse.decode(new BinaryReader(data)));
  }
  BlockGas(request: QueryBlockGasRequest = {}): Promise<QueryBlockGasResponse> {
    const data = QueryBlockGasRequest.encode(request).finish();
    const promise = this.rpc.request("stratos.evm.v1.Query", "BlockGas", data);
    return promise.then((data) => QueryBlockGasResponse.decode(new BinaryReader(data)));
  }
  AddressConvert(request: QueryAddressConvertRequest): Promise<QueryAddressConvertResponse> {
    const data = QueryAddressConvertRequest.encode(request).finish();
    const promise = this.rpc.request("stratos.evm.v1.Query", "AddressConvert", data);
    return promise.then((data) => QueryAddressConvertResponse.decode(new BinaryReader(data)));
  }
}
