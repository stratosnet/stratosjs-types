...
export const LegacyTx = {
  typeUrl: "/stratos.evm.v1.LegacyTx",
...
export const AccessListTx = {
  typeUrl: "/stratos.evm.v1.AccessListTx",
...
export const DynamicFeeTx = {
  typeUrl: "/stratos.evm.v1.DynamicFeeTx",
...
export const ExtensionOptionsEthereumTx = {
  typeUrl: "/stratos.evm.v1.ExtensionOptionsEthereumTx",
